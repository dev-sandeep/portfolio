  ...
  function updateHashFromScroll() {
    ...
    if (current !== lastId) {
      ...
      if (current) {
        ...
        document.querySelectorAll('.insp-nav-links a[href="index.html"], .insp-nav-links a[href="./"], .insp-nav-links a:not([href*="#"])').forEach(function (anchor) {
          if ((anchor.getAttribute('href') || '').indexOf('index.html') !== -1 && !anchor.getAttribute('href').includes('#')) {
